...
class NetworkController extends \schema\controller\MainController
{
    protected $conn;
    ...
    public function handleRequest() {
        ...
        $requestData = [
            'transactionHash' => $_POST['transaction-hash'] ?? null, // default value is null
            'inputAddress' => $_POST['input-address'] ?? null,
            'outputAddress' => $_POST['output-address'] ?? null,
            'blockId' => $_POST['block-id'] ?? null,
            'connectionsCount' => $_POST['connections-count'] ?? 300, // default value
            'startTimestamp' => $_POST['start-timestamp'] ?? null,
            'endTimestamp' => $_POST['end-timestamp'] ?? null,
        ];
